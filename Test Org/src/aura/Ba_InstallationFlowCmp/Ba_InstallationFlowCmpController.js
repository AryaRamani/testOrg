({
    ...
    handleFlowSubmit: function(component, event, helper) {
        ...
        alert('Enrollable Class' + JSON.stringify(component.get("v.enrollselectedlst")));
        alert('Probationary period' + JSON.stringify(component.get("v.GrpClass")));
    ...
    handleNavigateNext: function(component, event, helper) {
        ...
        if (benefit == undefined || benefit.length == 0) {} else {
    ...
    handleFlowPause: function(component, event, helper) {
        ...
        alert('Id' + taskChapters[component.get("v.currentChapterSequence")].Id);
        var getTaskChptrAction = component.get("c.pauseFlowInfo");
        getTaskChptrAction.setParams({
            "GroupId": component.get("v.GroupId"),
            "info": JSON.stringify(amap),
            "task": taskChapters[component.get("v.currentChapterSequence")].Id,
            "flowname": 'BAMInstallEmployerGroup'
        });
