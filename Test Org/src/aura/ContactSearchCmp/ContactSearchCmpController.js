({
  ...
  var index = event.getSource().get("v.text");
     ...
     // var index = component.get("v.index");
      ...
      var contactdata = component.get("v.Contacts");
       contactdata[index].selected = true;
       //component.set("v.Contacts", contactdata);
    var selectedvalue = component.get("v.contactsNew");
   ...
   var selectedcode= [];
      ...
      selectedcode.push(selectedvalue[i]);
       ...
       selectedcode.push(contactdata[index]);
       component.set("v.contactsNew", selectedcode);
  /*   var selectedvalue = component.get("v.CntctId");
            var selectedcode = [];
            selectedcode.push(selectedvalue);
      selectedcode.push(contactdata[index].Id)
     component.set("v.CntctId", selectedcode);*/
           ...
           var contactdata = component.get("v.Contacts");
          var selectedvalue = component.get("v.contactsNew"); 
            var indexnew = selectedvalue.indexOf(contactdata[index])
            console.log(indexnew)
            
    selectedvalue.splice(indexnew, 1);
               
     component.set("v.contactsNew", selectedvalue);    
     ...
     component.set("v.CntctId", selectedvalue);*/
      ...
      /*  var contactdata = component.get("v.Contacts");
        contactdata[index].selected = true;
        component.set("v.contactsNew", contactdata);*/
      // var k = event.currentTarget.id
     /* var chkd= event.currentTarget.checked;
        if(chkd== true){
      console.log(Number(k));
      
        var ContactNew = component.get("v.Contacts[0]");
       ...
       // var acct = component.get("v.AcctTm");
        var setEvent1 = $A.get("e.c:SelectContactEvent");
            setEvent1.setParams({'ContactAttr':component.get("v.contactsNew")});
       setEvent1.fire();
        var test1 = setEvent1.getParam("ContactAttr")
        console.log(test1.FirstName)
           ...
           // var acct = component.get("v.AcctTm");
         var setEvent1 = $A.get("e.c:SelectContactEvent");
        setEvent1.setParams({'ContactAttr':""});
       setEvent1.fire();
        var test1 = setEvent1.getParam("ContactAttr")
 ...
 SaveRcd : function(component, event, helper){
    /* var index = component.get("v.index");
     ...
     var selectedcode = [];
      ...
      var setEvent1 = $A.get("e.c:ContactSearchEvent");
     var CnId = component.get("v.contactsNew");
     //setEvent1.setParams({'ContactAttr': component.get("v.CntctId")});
     setEvent1.setParams({'ContactAttr': component.get("v.contactsNew")});
       setEvent1.fire();
        var test1 = setEvent1.getParam("ContactAttr")
