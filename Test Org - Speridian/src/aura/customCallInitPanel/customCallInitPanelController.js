...
({
    ...
    init : function(cmp, event, helper) {
        var head = document.getElementsByTagName('head')[0];
            ...
            script.src = "https://benefitalign-dev-ed.lightning.force.com/support/api/40.0/lightning/opencti_min.js"; 
            script.type = 'text/javascript';
            script.key = "https://benefitalign-dev-ed.lightning.force.com/support/api/40.0/lightning/opencti_min.js"; 
            script.helper = this;
